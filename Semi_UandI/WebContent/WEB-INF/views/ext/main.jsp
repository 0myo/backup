...
<html>
<head>
  <link href = "<%=request.getContextPath()%>/resources/css/styles.css?ver=20" rel = "stylesheet">
  <meta charset="utf-8">
  <script
  ...
  <script src="<%=request.getContextPath()%>/resources/js/script_main.js?ver=13"></script>
</head>
<body>
  ...
  <a href = "#" target = "_blank"><img src = "<%=request.getContextPath()%>/resources/images/github.png" class = "icon" id = "facebook"></a>
  <a href = "#" target = "_blank"><img src = "<%=request.getContextPath()%>/resources/images/instagram.png" class = "icon" id = "instagram"></a>
  <img src = "<%=request.getContextPath()%>/resources/images/arrow.gif" class = "arrow">
  ...
  <div>
    ...
    <ul class = "slider">
      ...
      <li class = "page jb-box" id = "page1" alt="">
        <video autoplay loop>
          <source src="<%=request.getContextPath()%>/resources/images/main.mp4" type="video/mp4">
