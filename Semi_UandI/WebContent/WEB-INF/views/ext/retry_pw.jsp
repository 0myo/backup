  ...
  <div id="carouselExampleControls" class="carousel slide container" data-bs-ride="carousel"> 
    <div class="carousel-inner">
      <div class="carousel-item active">
         <img src="<%=request.getContextPath()%>/resources/images/FirstPage.PNG" class="d-block w-100" alt="...">
		<img src="<%=request.getContextPath()%>/resources/images/SecondPage.PNG" class="d-block w-100" alt="...">
		<img src="<%=request.getContextPath()%>/resources/images/ThirdPage.PNG" class="d-block w-100" alt="...">
      </div>
    </div>
