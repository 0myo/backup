				...
				<div class="card card-outline card-info">
					<div class="card-header">
						...
						<div class ="card-tools">
							<button type="button" class="btn btn-primary" id="modifyBtn" onclick="modify_go('${free.nno}');">수 정</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="btn btn-danger" id="removeBtn" onclick="remove_go('${free.nno}');">삭 제</button>
							&nbsp;&nbsp;&nbsp;&nbsp;
