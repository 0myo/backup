 ...
 * Generated at: 2022-11-27 02:56:39 UTC
...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/stu/./main_js.jsp", Long.valueOf(1669516538913L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		<option value='attendWid' data-li='attendWidget'onclick=\"f_editStart()\">출석 현황(3x3)</option>\r\n");
      out.write("		<option value='scoreWid' data-li='scoreWidget'onclick=\"f_editStart()\">이번학기성적(3x3)</option>\r\n");
      out.write("		</select>\r\n");
      out.write("      </div>\r\n");
      out.write("      \r\n");
      ...
      out.write(" 										<div class=\"d-inline-block\"><button class=\"btn btn-rounded btn-primary btn-lg\">학생</button></div>\r\n");
      out.write("										&nbsp;&nbsp;&nbsp;\r\n");
      ...
      out.write("										</div>\r\n");
      out.write(" 									</div>\r\n");
      out.write(" 									<div class=\"row d-flex\" style=\"padding: 20px 20px 20px 0px;\">\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${member.anoCd}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"\r\n");
      ...
      out.write(" 												<p class=\"alert alert-primary m-1\">`+rslt.colName+`<br>`+rslt.major+`</p>\r\n");
      out.write(" 												<p class=\"alert alert-primary m-1\"\r\n");
      out.write(" 												style=\"padding: 5px 5px 5px 5px;\">`+rslt.grade+`학년 / `+rslt.acaStateCd+`</p>\r\n");
      out.write(" 												<p class=\"alert alert-primary m-1\" style=\"padding: 5px 5px 5px 5px;\">학번&nbsp;");
      ...
      out.write("	var v_allWidgetList = JSON.parse(localStorage.getItem(\"allWidgetList\"));\r\n");
      out.write("	for(var i = 0; i<v_allWidgetList.length; i++){\r\n");
      out.write("		if(v_allWidgetList[i].id == 10){\r\n");
      out.write("			v_json.w = v_allWidgetList[i].w;\r\n");
      out.write("			v_json.h = v_allWidgetList[i].h;\r\n");
      out.write("			v_json.noResize = v_allWidgetList[i].noResize;\r\n");
      out.write("		}\r\n");
      ...
      out.write("		url:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${webPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/portlet/stutimetable',\r\n");
      out.write("		success: (rslt) => {\r\n");
      out.write("			console.log(\"학생시간표\",rslt);\r\n");
      ...
      out.write("				if(subjName.length > 8){\r\n");
      ...
      out.write("}\r\n");
      out.write("//11.출석현황\r\n");
      out.write("var f_addAttendWidget = (paramX,paramY) => {\r\n");
      out.write("	var v_json=\r\n");
      out.write("	{\r\n");
      out.write("    \"id\": 11\r\n");
      out.write("    };\r\n");
      out.write("	var v_allWidgetList = JSON.parse(localStorage.getItem(\"allWidgetList\"));\r\n");
      out.write("	for(var i = 0; i<v_allWidgetList.length; i++){\r\n");
      out.write("		if(v_allWidgetList[i].id == 11){\r\n");
      out.write("			v_json.w = v_allWidgetList[i].w;\r\n");
      out.write("			v_json.h = v_allWidgetList[i].h;\r\n");
      out.write("			v_json.noResize = v_allWidgetList[i].noResize;\r\n");
      out.write("		}\r\n");
      ...
      out.write("		url:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${webPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/portlet/attend',\r\n");
      out.write("		success: (rslt) => {\r\n");
      out.write("			console.log(\"어텐드\",rslt);\r\n");
      out.write("			var bodyContent = \r\n");
      out.write("		         `<div class=\"card-body row justify-content-center\" style=\"overflow-y:hidden; overflow-x:hidden; height:287px;\">\r\n");
      out.write("		         	<canvas id=\"attendChart\" style=\"height:180px;\"></canvas>\r\n");
      out.write("		         </div>`;\r\n");
      out.write("	        \r\n");
      out.write("			var attendWidget = f_widgetTemplate('&nbsp;출석현황',bodyContent,'attendWid','attendWidget');\r\n");
      out.write("			\r\n");
      out.write("			if(paramX != null && paramY != null){\r\n");
      out.write("				v_json.x = paramX; \r\n");
      out.write("				v_json.y = paramY;\r\n");
      out.write("			}\r\n");
      out.write("			\r\n");
      out.write("			v_json.content=attendWidget; \r\n");
      out.write("			usedWidgetList.push(v_json); //배열추가\r\n");
      out.write("			grid.addWidget(v_json);		//위젯추가\r\n");
      out.write("			localStorage.setItem(\"usedWidgetList\",JSON.stringify(usedWidgetList)); //로컬스토리지추가\r\n");
      out.write("			\r\n");
      out.write("			const ctx = document.getElementById('attendChart').getContext('2d');\r\n");
      out.write("			\r\n");
      out.write("			const a_labels = [];\r\n");
      out.write("			for(var i=0; i<rslt.length; i++){\r\n");
      out.write("				a_labels.push(rslt[i].subjName);\r\n");
      out.write("			}\r\n");
      out.write("			const a_attend = [];\r\n");
      out.write("			for(var i=0; i<rslt.length; i++){\r\n");
      out.write("				a_attend.push(rslt[i].attendCnt);\r\n");
      out.write("			}\r\n");
      out.write("			const a_absent = [];\r\n");
      out.write("			for(var i=0; i<rslt.length; i++){\r\n");
      out.write("				a_absent.push(rslt[i].absentCnt);\r\n");
      out.write("			}\r\n");
      out.write("			const a_late = [];\r\n");
      out.write("			for(var i=0; i<rslt.length; i++){\r\n");
      out.write("				a_late.push(rslt[i].lateCnt);\r\n");
      out.write("			}\r\n");
      out.write("			const a_le = [];\r\n");
      out.write("			for(var i=0; i<rslt.length; i++){\r\n");
      out.write("				a_le.push(rslt[i].leCnt);\r\n");
      out.write("			}\r\n");
      out.write("			const a_bgcolor = ['#B4ED4C','#FF7B67','#FFF26D'];\r\n");
      out.write("			\r\n");
      ...
      out.write("			    {\r\n");
      out.write("			      label: '출석',\r\n");
      out.write("			      data: a_attend,\r\n");
      out.write("			      backgroundColor:a_bgcolor[0],\r\n");
      out.write("			    },\r\n");
      out.write("			    {\r\n");
      out.write("			      label: '결석',\r\n");
      out.write("			      data: a_absent,\r\n");
      out.write("			      backgroundColor:a_bgcolor[1],\r\n");
      out.write("			    },\r\n");
      out.write("			    {\r\n");
      out.write("			      label: '지각',\r\n");
      out.write("			      data: a_late,\r\n");
      out.write("			      backgroundColor:a_bgcolor[2],\r\n");
      out.write("			    },\r\n");
      out.write("			    {\r\n");
      out.write("			      label: '조퇴',\r\n");
      out.write("			      data: a_le,\r\n");
      ...
      out.write("			};\r\n");
      out.write("			\r\n");
      out.write("		    const attendChart = new Chart(ctx, {\r\n");
      out.write("				  type: 'bar',\r\n");
      out.write("				  data: data,\r\n");
      out.write("				  options: {\r\n");
      out.write("// 				    plugins: {\r\n");
      ...
      out.write("// 				          text: 'Chart.js Bar Chart - Stacked'\r\n");
      out.write("// 				        },\r\n");
      out.write("// 				      },\r\n");
      ...
      out.write("		    });\r\n");
      out.write("		\r\n");
      out.write("			$('div[class=ms-selectable]>ul>li[data-li=\"attendWidget\"]').attr('class','ms-elem-selectable ms-selected').css('display','none');\r\n");
      out.write("			$('div[class=ms-selection]>ul>li[data-li=\"attendWidget\"]').attr('class','ms-elem-selection ms-selected').css('display','');\r\n");
      out.write("		},\r\n");
      out.write("		error: () => {\r\n");
      out.write("			AjaxErrorSecurityRedirectHandler(error.status);\r\n");
      out.write("		}\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("//12.이번학기 성적\r\n");
      out.write("var f_addScoreWidget = (paramX,paramY) => {\r\n");
      out.write("// 	alert('공지추가');\r\n");
      out.write("	var v_json=\r\n");
      out.write("	{\r\n");
      out.write("    \"id\": 12\r\n");
      ...
      out.write("	var v_allWidgetList = JSON.parse(localStorage.getItem(\"allWidgetList\"));\r\n");
      out.write("	for(var i = 0; i<v_allWidgetList.length; i++){\r\n");
      out.write("		if(v_allWidgetList[i].id == 12){\r\n");
      out.write("			v_json.w = v_allWidgetList[i].w;\r\n");
      out.write("			v_json.h = v_allWidgetList[i].h;\r\n");
      out.write("			v_json.noResize = v_allWidgetList[i].noResize;\r\n");
      out.write("		}\r\n");
      ...
      out.write("		url:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${webPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/portlet/score',\r\n");
      out.write("		success: (rslt) => {\r\n");
      out.write("			console.log(\"성적\",rslt);\r\n");
      out.write("			var v_rslt = JSON.stringify(rslt);\r\n");
      out.write("			var bodyContent = \r\n");
      out.write("		         `<div class=\"card-body row justify-content-center\" style=\"overflow-y:hidden; overflow-x:hidden; height:286px;\">\r\n");
      out.write("		         	<canvas id=\"subGradeChart\" style=\"height:200px;\"></canvas>\r\n");
      out.write("		         </div>`;\r\n");
      out.write("\r\n");
      out.write("	        \r\n");
      out.write("			var scoreWidget = f_widgetTemplate('&nbsp;이번학기성적',bodyContent,'scoreWid','scoreWidget');\r\n");
      out.write("			\r\n");
      out.write("			if(paramX != null && paramY != null){\r\n");
      out.write("				v_json.x = paramX; \r\n");
      out.write("				v_json.y = paramY;\r\n");
      out.write("			}\r\n");
      out.write("			\r\n");
      out.write("			v_json.content=scoreWidget; \r\n");
      out.write("			usedWidgetList.push(v_json); //배열추가\r\n");
      out.write("			grid.addWidget(v_json);		//위젯추가\r\n");
      out.write("			console.log(\"시간표추가 펑션에서 set\");\r\n");
      out.write("			localStorage.setItem(\"usedWidgetList\",JSON.stringify(usedWidgetList)); //로컬스토리지추가\r\n");
      ...
      out.write("			for(var i=0; i<rslt.subScoreDist.label.length; i++){\r\n");
      out.write("				subjLabel.push(rslt.subScoreDist.label[i]);\r\n");
      out.write("			}\r\n");
      out.write("			console.log(\"푸쉬\",subjLabel);\r\n");
      ...
      out.write("	                    data: rslt.subScoreDist.data,\r\n");
      out.write("	                    fill: true,\r\n");
      ...
      out.write("			\r\n");
      out.write("			\r\n");
      out.write("			$('div[class=ms-selectable]>ul>li[data-li=\"scoreWidget\"]').attr('class','ms-elem-selectable ms-selected').css('display','none');\r\n");
      out.write("			$('div[class=ms-selection]>ul>li[data-li=\"scoreWidget\"]').attr('class','ms-elem-selection ms-selected').css('display','');\r\n");
      out.write("			\r\n");
      out.write("		}, \r\n");
      out.write("		error: () => {\r\n");
      out.write("			AjaxErrorSecurityRedirectHandler(error.status);\r\n");
      ...
      out.write("					}else if(rslt.allPoList[i].defaultCd == \"Y\" && rslt.allPoList[i].id == 10){\r\n");
      out.write("						f_addTimetableWidget();\r\n");
      out.write("					}else if(rslt.allPoList[i].defaultCd == \"Y\" && rslt.allPoList[i].id == 11){\r\n");
      out.write("						f_addAttendWidget();\r\n");
      out.write("					}else if(rslt.allPoList[i].defaultCd == \"Y\" && rslt.allPoList[i].id == 12){\r\n");
      out.write("						f_addScoreWidget();\r\n");
      out.write("					}\r\n");
      out.write("								\r\n");
      out.write("				}\r\n");
      out.write("			}else{\r\n");
      ...
      out.write("					case 11:\r\n");
      out.write("						//지도학생관리\r\n");
      out.write("						f_addAttendWidget(rslt.poList[i].x,rslt.poList[i].y);\r\n");
      out.write("						break;\r\n");
      out.write("					case 12:\r\n");
      out.write("						//과제제출현황\r\n");
      out.write("						f_addScoreWidget(rslt.poList[i].x,rslt.poList[i].y);\r\n");
      out.write("						break;\r\n");
      out.write("						\r\n");
      out.write("					}\r\n");
      out.write("				}\r\n");
      ...
      out.write("        	f_addTimetableWidget();\r\n");
      out.write("        }else if(values == 'attendWid' || $('#attendWid') == null){\r\n");
      out.write("        	f_addAttendWidget();\r\n");
      out.write("        }else if(values == 'scoreWid' || $('#scoreWid') == null){\r\n");
      out.write("        	f_addScoreWidget();\r\n");
      out.write("        }\r\n");
      out.write("	},\r\n");
      ...
      out.write("			grid.removeWidget(gra);\r\n");
      out.write("			\r\n");
      out.write("    	}else if(values == 'attendWid'){\r\n");
      out.write("			var obj = document.querySelector(\"#attendWid\");\r\n");
      out.write("			var par = obj.parentNode;\r\n");
      out.write("			var gra = par.parentNode;\r\n");
      out.write("			\r\n");
      out.write("			var v_usedWidgetList = JSON.parse(localStorage.getItem(\"usedWidgetList\"));\r\n");
      ...
      out.write("			grid.removeWidget(gra);\r\n");
      out.write("			\r\n");
      out.write("    	}else if(values == 'scoreWid'){\r\n");
      out.write("			var obj = document.querySelector(\"#scoreWid\");\r\n");
      out.write("			var par = obj.parentNode;\r\n");
      out.write("			var gra = par.parentNode;\r\n");
      out.write("			\r\n");
      out.write("			var v_usedWidgetList = JSON.parse(localStorage.getItem(\"usedWidgetList\"));\r\n");
